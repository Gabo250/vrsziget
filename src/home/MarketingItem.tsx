      ...
      {swap ? (
        ...
        >
          ...
          <div className="relative">
            <div
              className={`relative ${bg} z-[10] bg-cover  bg-center w-[27rem] h-[13.5rem]`}
            />
            <div className="absolute rounded-full -top-28 blur-[8rem] left-0 w-[28rem] z-0 h-[28rem] [background:radial-gradient(circle,_rgba(54,13,106,0.4)_0%,_rgba(17,134,150,0.3981967787114846)_50%,_rgba(31,2,68,0.4)_100%)]" />
          </div>
        </article>
      ) : (
        <article
        ...
        >
          <div className="relative">
            <div className={`relative ${bg} z-[10] bg-cover  bg-center w-[27rem] h-[26rem]`} />
            <div className="absolute rounded-full -top-28 blur-[8rem] left-0 w-[28rem] z-0 h-[28rem] [background:radial-gradient(circle,_rgba(54,13,106,0.4)_0%,_rgba(17,134,150,0.3981967787114846)_50%,_rgba(31,2,68,0.4)_100%)]" />
          </div>
