...
function GameSection() {
    return (
        <section className="relative flex flex-col justify-center items-center gap-16 w-full h-[45rem] bg-gradient-to-b top-[22rem] from-[#110317] from-[25%] via-l-purple to-[75%] to-[#0F0417] md:top-[28.98rem]">
