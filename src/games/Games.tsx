...
const gamesko: gameType[] = [
...

  {
    ...
    description: "Lépj be a vadnyugat legveszélyesebb világába! Vedd fel a seriff csillagot, és tedd próbára bátorságodat a legfélelmetesebb pisztolypárbajokban és banditavadászatokban, amelyek eddig csak a mozivásznon léteztek. Teszteld képességeidet a kor legikonikusabb fegyvereivel, és éld át, milyen érzés igazi pisztolyhősként harcolni. Hívd ki barátaidat egy párbajra, vagy csatlakozz egy csapathoz, és közösen uraljátok a vadnyugatot!"
  },
...

  {
    ...
    description: "Bárcsak meg tudnánk változtatni a múltat, vagy szemtanúi lehetnénk azoknak eseményeknek, amik megváltoztatták a világot... Meg lehet változtatni a sorsot? Utazz vissza az időben, hogy ha megváltoztasd a helyzetet, amelyből, úgy tűnt — nem volt kiút. Mi történt a baleset éjszakáján? Mi történt utána? Találj válaszokat, az eddig megválaszolatlan kérdésekre. Csernobil szellemvárosa elmeséli a történetét... A történetet, ami életekbe került. Egy katasztrófa, ami még ma is hatással van ránk.."
  },
...

  {
    ...
    description: "Ki szeretted volna próbálni magad az íjászatban? Álmodoztál arról, hogy a középkor hősévé válj? Az Archer játékban az erődöt megtámadó orkok, koboldo és trollok hordáival kell harcolnod, és végezetül le kell győznöd a fő-főnököt! Harcolhatsz egyedül, mint egy igazi hős, vagy segítségül hívhatod a barátaid, és együtt lőhetitek a szörnyeket. Siess! Ragadj íjat, és védd meg kastélyodat a hívatlan vendégekkel szemben!"
  },
        ...
        gamesko.map((game, id, gamesko) => {
          return (
            <Game 
              ...
              className={`${ id === gamesko.length - 1 ? "" : "before:absolute before:bg-gradient-to-l before:from-d-purple before:from-25% before:via-h-teal before:to-75% before:to-d-purple before:bottom-0 before:left-1/2 before:-translate-x-1/2 before:w-[30%] before:h-[1px]" }`}
            />
          );
        })
      } 
